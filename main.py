...
class Selector():
    ...
    def __init__(self, unidad="C"):
        self.__customes = []        
        self.__customes.append(pygame.image.load("images/posicionF.png"))
        self.__customes.append(pygame.image.load("images/posicionC.png"))
...
class mainApp():
    ...
    def __init__(self):
        ...
        self.entrada = NumberInput("cascotazo")
